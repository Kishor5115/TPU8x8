...
odb::dbObstruction_create $block $m2 [ord::microns_to_dbu 603] [ord::microns_to_dbu 2335] [ord::microns_to_dbu 608] [ord::microns_to_dbu 2339]
...
if {$grc != 0} {
    puts "WARNING: Strict global route failed ($gr_err)"
    puts "Retrying global route with -allow_congestion to continue flow..."
    global_route \
        -guide_file ${RESULT_DIR}/route.guide \
        -congestion_report_file ${REPORT_DIR}/05_congestion.rpt \
        -allow_congestion \
